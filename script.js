...
captureBtn.addEventListener('click', () => {
  ...
  const context = drawImageToCanvas(cameraFeed, cameraFeed.videoWidth || 224, cameraFeed.videoHeight || 224);
...
runBtn.addEventListener('click', async () => {
  ...
  try {
    ...
    const predictions = await classifier(imagePreview, CANDIDATE_LABELS);
