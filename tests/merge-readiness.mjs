...
assert.match(script, /@xenova\/transformers@2\.17\.2\/\+esm/, 'script.js must import the ESM Xenova build from the CDN');
...
assert.match(script, /classifier\(processingCanvas,\s*CANDIDATE_LABELS\)/, 'script.js must classify the resized canvas image');
